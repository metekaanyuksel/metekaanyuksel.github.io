...
- The observation that recombination varies dramatically along the genome (at fine and coarse scales) motivates a lot of the work that I have been doing. Particularly striking is how much the landscape (and rate) of recombination itself varies between gametes, individuals, sexes, populations, and species[^2]. A wealth of data (from population re-sequencing studies, single sperm sequencing, etc.) makes it an exciting time to think about variation in recombination at these scales.
