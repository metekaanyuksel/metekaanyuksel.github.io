...
- A particularly salient way recombination varies is along genomes. The landscape (i.e., probability distribution) of recombination varies between gametes, individuals, sexes, populations, and species[^2] and appears to be quite evolutionarily liable. A wealth of data (e.g., from single sperm sequencing) makes it an exciting time to think about variation in recombination at these scales.
